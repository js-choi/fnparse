(ns edu.arizona.fnparse
  ...
  *unambiguous parsers*.
  ...
  FnParse can write parsers with *unambiguous grammars*.
  ...
  JSON, Markdown, and most other computer languages.
  FnParse can indeed parse data in all those languages above.
  I think. :)
  
  English, like most other natural human languages, has an
  ambiguous grammar, because its sentences can have more
  than one meaning (e.g. "She watched her through her telescope.").
  ...
  functions that have some common characteristics.
  ...
  *  Rules consume tokens from the beginning of the sequence.
  ...
  -------------------------
  FnParse Hound is a Parsec-like, LL(1)-or-near-LL(1) parser.
  FnParse Cat is a packrat parser. All other differences stem
  from these two fundamental ones.
